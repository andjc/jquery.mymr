...
$(document).ready(function () {
  ...
  if(docLang != null) {
    ...
    $('*:lang(my)').html().replace(/(\u103A)(\u1037)/g, '$2$1');
    $('*:lang(my)').html().replace(/([\u1000-\u1021\u1023-\u1027\u1029\u102A])/g, '\u200B$1');
    $('*:lang(my)').html().replace(/([\u0009-\u000d\u0020\u00a0\u2000-\u200a\u2028\u2029\u202f]|>|\u201C|\u2018|\-|\(|\[|{|[\u2012-\u2014]|\u1039)\u200B([\u1000-\u1021])/g, '$1$2');
    $('*:lang(my)').html().replace(/\u200B(\u1004\u103A\u1039)/g, '$1');
    $('*:lang(my)').html().replace(/\u200B([က-အ]\u103A)/g, '$1');
    $('*:lang(my)').html().replace(/(\s|\n)\u200B([က-အဣ-ဧဩဪ])/g, '$1$2');
  }
});    
